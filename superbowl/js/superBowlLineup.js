...
console.log(superBowlLineup.bands.length);  //this line prints out the number of bands contained in the variable superBowlLinup
console.log(superBowlLineup.bands[1].name); //this 
